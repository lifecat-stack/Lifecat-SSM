				...
				<div class="modal-body">
					...
					<form class="form-group" action="LoginServlet"
						...
						<div class="text-right">
							<button class="btn btn-primary" type="submit" value="登录">登录</button>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-group" action="RegisterServlet" method="post">
						...
						<div class="form-group">
							<label for="password">密码</label> <input class="form-control"
								placeholder="请输入密码" name="rpassword" id="rpassword"
								type="password">
						</div>
						<div class="text-right">
			...
			<div class="nav">
				...
				<div class="entry">
					<span class="state">记录美好时刻</span> <a
						href="http://www.lifecat.club/" target="_blank">访问官网</a>
				</div>
			</div>
		</div>
		<div class="container">
						...
						<div class="main-entry">
							<a data-toggle="modal" data-target="#login" href=""
								class="developer-login"><span class="title"><i
									class="developer"></i>登陆</span><s></s> </a> <a data-toggle="modal"
